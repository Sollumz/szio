...
@pytest.mark.parametrize("cols,rows,compressed_shattermap", [
    ...
    (
        # E5DEE4F8----------------------------F8E4DEE5
        # BAB4BED9FB----FFEFE5E1E1E5EFFFFFFFFBD9BEB4BA
        # 918FA1C5E7--ECD6C5B9B4B4B9C5D6ECF5E7C5A18F91
        # 6B738FB9D6DBC9AF9A8B85858B9AAFC9DBD6B98F736B
        # 4C5F87B3C8C3A889705F56565F7089A8C3C8B3875F4C
        # 355481AAB9AC89674933272733496789ACB9AA815435
        # 244C7AA1A9966E48260C00000C26486E96A9A17A4C24
        # 18457495997F562E0800000000082E567F9995744518
        # 103D6B8886683F16000000000000163F6886886B3D10
        # ##35627A73512800000000000000002851737A6235##
        # ##2C56695F3A120000000000000000123A5F69562C##
        # ##2046534623000000000000000000002346534620##
        # ##0F2D362809000000000000000000000928362D0F##
        # ############################################
        22, 14,
        b""
    ),
])
